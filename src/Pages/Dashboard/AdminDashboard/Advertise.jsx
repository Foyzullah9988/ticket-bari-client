...
const AdvertiseTickets = () => {
    ...
    console.log('All Tickets:', tickets); // Debug: সব টিকেট দেখুন
    ...
    const advertisedTickets = approvedTickets.filter(ticket => 
        ticket.isAdvertise === true
    );

    console.log('Approved Tickets:', approvedTickets); // Debug: approved টিকেট
    console.log('Advertised Tickets:', advertisedTickets); // Debug: advertised টিকেট
