            ...
            <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <div className="flex justify-between items-center border-b pb-3">
                                    ...
                                    <span className="px-4 py-1 bg-green-100 text-green-800 rounded-full font-bold">
                                        CONFIRMED
                                    </span>
                                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link 
                        ...
                        className="inline-flex items-center justify-center px-6 py-3 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 transition shadow-lg"
                    >
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center px-6 py-3 border-2 border-green-600 text-green-600 font-bold rounded-lg hover:bg-green-50 transition"
                    >
                        Print Receipt
                    </button>
                    ...
                    <Link 
                        to="/" 
                        className="inline-flex items-center justify-center px-6 py-3 border-2 border-gray-300 text-gray-700 font-bold rounded-lg hover:bg-gray-50 transition"
                    >
                        Back to Home
                    </Link>
                </div>
                ...
                <div className="mt-12 bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="text-center">
                            ...
                            <h4 className="font-bold text-gray-800 mb-2">Save Your Ticket</h4>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div className="text-center">
                            ...
                            <h4 className="font-bold text-gray-800 mb-2">Travel Day</h4>
                            <p className="text-gray-600 text-sm">
