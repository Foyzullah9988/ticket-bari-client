                            ...
                            >
                                ...
                                <div className="relative overflow-hidden rounded-xl mb-4">
                                    <figure className="relative">
                                        ...
                                        />
                                        {/* linear overlay that changes in dark mode */}
                                ...
                                <div className="mt-auto pt-4 border-t border-gray-200 dark:border-gray-800">
                                    <Link
                                        ...
                                        className="group/btn w-full inline-flex items-center justify-center gap-2 bg-linear-to-l from-green-500 to-green-900 dark:to-black/90 dark:from-black/5
